...
<div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row mt-12 mb-12">
    <img src="https://images.pexels.com/photos/1144864/pexels-photo-1144864.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" className="h-80 dark:bg-gray-500 aspect-video" />
	...
	<div className="container mx-auto">
		<div className="flex flex-col lg:flex-row items-center justify-between">
			...
			<a href="#" rel="noreferrer noopener" className="px-5 mt-4 lg:mt-0 py-3 rounded-md border block dark:bg-gray-50 dark:text-gray-900 dark:border-gray-400">Buy Now</a>
		</div>
	</div>
</div>
